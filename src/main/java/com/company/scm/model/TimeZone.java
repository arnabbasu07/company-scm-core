...
//	ACDT("ACDT","Australian Central Daylight Savings Time","UTC+10:30"),
	ACDT("ACDT","Australian Central Standard Time","UTC+09:30"),
//	ACT("ACT","Acre Time","UTC−05"),
	ACT("ACT","ASEAN Common Time","UTC+08"),
	ADT("ADT","Atlantic Daylight Time","UTC−03"),
	AEDT("AEDT","Australian Eastern Daylight Savings Time","UTC+11"),
	AEST("AEST","Australian Eastern Standard Time","UTC+10"),
	AFT("AFT","Afghanistan Time","UTC+04:30"),
	AKDT("AKDT","Alaska Daylight Time","UTC−08"),
	AKST("AKST","Alaska Standard Time","UTC−09"),
//	AMST("AMST","Amazon Summer Time (Brazil)[1]","UTC−03"),
	AMST("AMST","Armenia Summer Time","UTC+05"),
	/*TimeZone("AMT","Amazon Time (Brazil)[2]","UTC−04"),
	TimeZone("AMT","Armenia Time","UTC+04"),
	TimeZone("ART","Argentina Time","UTC−03"),
	TimeZone("AST","Arabia Standard Time","UTC+03"),
	TimeZone("AST","Atlantic Standard Time","UTC−04"),
	TimeZone("AWDT","Australian Western Daylight Time","UTC+09"),
	TimeZone("AWST","Australian Western Standard Time","UTC+08"),
	TimeZone("AZOST","Azores Standard Time","UTC−01"),
	TimeZone("AZT","Azerbaijan Time","UTC+04"),
	TimeZone("BDT","Brunei Time","UTC+08"),
	TimeZone("BDT","Bangladesh Daylight Time (Bangladesh Daylight saving time keeps UTC+06 offset) [3]","UTC+06"),
	TimeZone("BIOT","British Indian Ocean Time","UTC+06"),
	TimeZone("BIT","Baker Island Time","UTC−12"),
	TimeZone("BOT","Bolivia Time","UTC−04"),
	TimeZone("BRST","Brasilia Summer Time","UTC−02"),
	TimeZone("BRT","Brasilia Time","UTC−03"),
	TimeZone("BST","Bangladesh Standard Time","UTC+06"),
	","BST","Bougainville Standard Time[4]","UTC+11"),
	...
	","CDT","Cuba Daylight Time[5]","UTC−04"),
	...
	","DFT","AIX specific equivalent of Central European Time[6]","UTC+01"),
...
*/	EST("EST","Eastern Standard Time (North America)","UTC−05"),
...
*/	IST("IST","Indian Standard Time","UTC+05:30"),
	/*","IST","Irish Standard Time[7]","UTC+01"),
...
*/	PDT("PDT","Pacific Daylight Time (North America)","UTC−07"),
...
*/	PST("PST","Pacific Standard Time (North America)","UTC−08"),
	/*","PST","Philippine Standard Time","UTC+08"),
	","PYST","Paraguay Summer Time (South America)[8]","UTC−03"),
	","PYT","Paraguay Time (South America)[9]","UTC−04"),
...
*/	YAKT("YAKT","Yakutsk Time","UTC+09"),
	YEKT("YEKT","Yekaterinburg Time","UTC+05");

	private String code;
	private String timezone;
	private String UTC;

	TimeZone(String code, String timezone, String UTC){
		this.code = code;
